...
class Uniswapv2router extends _i1.GeneratedContract {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<List<BigInt>> getAmountsOut$2(
      BigInt amountIn, List<_i1.EthereumAddress> path, BigInt fee,
      {_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[25];
    assert(checkSignature(function, '4955796c'));
    final params = [amountIn, path, fee];
    final response = await read(function, params, atBlock);
    return (response[0] as List<dynamic>).cast<BigInt>();
  }
}
